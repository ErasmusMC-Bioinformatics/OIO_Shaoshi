...
cell_annotation = 'Endothelial Cells'
prediction = list(prediction[cell_annotation])

preset = pd.read_csv('Endothelial_Cells.TestTarget.txt',index_col=0,delimiter='\t')
...
plt.title('Endothelial Cell Prediction',fontsize=15)

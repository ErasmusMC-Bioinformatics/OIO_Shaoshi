...
selected_cell = 'Endothelial_Cells'
predefine_file = 'Endothelial_Cells.TestTarget.txt'

prediction = pd.read_csv('Cibersortx.Prediction.csv',index_col=0)
prediction = prediction['Endothelial Cells']

predefine = pd.read_csv(predefine_file,delimiter='\t')
predefine = predefine['Endothelial Cells']

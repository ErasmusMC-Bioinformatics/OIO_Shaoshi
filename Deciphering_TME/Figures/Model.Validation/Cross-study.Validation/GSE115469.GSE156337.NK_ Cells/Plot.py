...
cell_annotation = 'NK-like_Cells'
prediction = list(prediction['NK-like_Cells'])

preset = pd.read_csv('Nk_Cells.TestTarget.txt',index_col=0,delimiter='\t')
preset = list(preset['Nk Cells'])
...
plt.title('NK-like Cell (GSE115469) - NK Cell (GSE156337)',fontsize=15)

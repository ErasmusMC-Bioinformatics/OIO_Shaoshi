...
selected_cell = 'Stellate_cells'
predefine_file = 'Stellate_cells.TestTarget.txt'

prediction = pd.read_csv('Cibersortx.Prediction.csv',index_col=0)
prediction = prediction['Hepatic_Stellate_Cells']

predefine = pd.read_csv(predefine_file,delimiter='\t')
predefine = predefine['Stellate cells']
